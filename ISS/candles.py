...
class Candles(object):
    ...
    def load(self):
        ...
        while self.__len == self.__limit:
            c = candles(engine=self.__engine, market=self.__market, boardid=self.__boardid,
                securityid=self.__securityid, start=self.__start,
                dt1=self.__dt1, dt2=self.__dt2, interval=self.__interval)
            data.append(c)
