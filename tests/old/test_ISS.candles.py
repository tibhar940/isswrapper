...
from isswrapper.loaders.candles import Candles, candles
...
c = candles(
    ...
    boardid="TQBR",
    securityid="SBER",
    dt1=datetime.date(2017, 9, 1),
    dt2=datetime.date(2017, 9, 5),
)
print(c.shape)
print(c.head())
print(c.info())
...
C = Candles(
    engine="stock", market="shares", boardid="TQBR", securityid="SBER", dt1=datetime.date(2017, 1, 1), interval=24
)
print(C)
C.load()
print(C)
